...
-(void)createPaymentTimer{
    ...
    /*
     UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"High Volume" message:@"dono is experiencing high volume, or a weak internet connecition, please be patient..." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
     [alert show];
