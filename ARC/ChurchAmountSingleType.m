...
-(void)webSuccess:(NSNotification *)notification{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"ChurchAmountSingleType.webSuccess" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
-(void)webFailure:(NSNotification *)notification{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"ChurchAmountSingleType.webFailure" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
-(void)goToWebPayment{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"ChurchAmountSingleType.goToWebPayment" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
