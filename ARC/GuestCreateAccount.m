    ...
    @try {
        ...
        if ([status isEqualToString:@"success"]) {
            ...
            if (self.askSaveCard) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Success!" message:@"Thank you for registering, email receipts will now be sent to you!" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
                [alert show];
    ...
    @try {
        ...
        if ([status isEqualToString:@"success"]) {
            ...
            if (self.askSaveCard) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Success!" message:@"Your account is now linked!" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
                [alert show];
