...
-(void)webSuccess:(NSNotification *)notification{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"ChurchAmountMultipleTypes.webSuccess" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
-(void)webFailure:(NSNotification *)notification{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"ChurchAmountMultipleTypes.webFailure" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
-(void)goToWebPayment{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"ChurchAmountMultipleTypes.goToWebPayment" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
