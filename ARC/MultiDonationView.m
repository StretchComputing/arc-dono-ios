...
-(void)setQuickPays{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"MultiDonationView.setQuickPays" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
- (void)viewDidLoad
{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"MultiDonationView.viewDIdLoad" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
-(void)textBeginEdit{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"MultiDonationView.textBeginEdit" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
-(void)cancel{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"MultiDonationView.cancel" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
...
-(void)pay{
    ...
    @catch (NSException *exception) {
        [rSkybox sendClientLog:@"MultiDonationView.pay" logMessage:@"Exception Caught" logLevel:@"error" exception:exception];
