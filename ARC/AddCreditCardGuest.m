...
-(void)paymentSuccess{
    ...
    title = @"Success!";
    payString = [NSString stringWithFormat:@"Congratulations, your donation of $%@ was successfully processed!", payAmount];
    ...
    if (self.isGuest) {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:title message:payString delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
        [alert show];
        ...
        payString = [payString stringByAppendingString:@"Would you like us to securely encrypt and save your credit card information?"];
        
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:title message:payString delegate:self cancelButtonTitle:@"No Thanks" otherButtonTitles:@"Yes", nil];
        [alert show];
...
-(void)setAccessoryToolbars{
    ...
    [self.creditCardSecurityCodeText setInputAccessoryView:toolbar1];
