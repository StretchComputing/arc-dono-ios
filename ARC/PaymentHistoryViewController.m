    ...
    @try {
        ...
        if ([status isEqualToString:@"success"]) {
            ...
            if ([self.paymentsArray count] > 0) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"No Donations Found" message:@"No donations were found in your history." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
                [alert show];
            }
        ...
        if([errorMsg length] > 0) {
            ...
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Donations Error" message:@"We experienced an error loading your donation history, please try again." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
            [alert show];
        }
